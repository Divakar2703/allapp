        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              getLabel("Short By"),
              SizedBox(height: 15),
              OptionItem(text: "Relevance"),
              SizedBox(height: 15),
              OptionItem(text: "Price (Low to High)"),
              SizedBox(height: 15),
              OptionItem(text: "Price (High to Low)"),
              SizedBox(height: 15),
              OptionItem(text: "Popularity"),
              SizedBox(height: 15),
              OptionItem(text: "Discount (High to Low)"),
              SizedBox(height: 30),
              getLabel("Categories"),
              SizedBox(height: 15),
